...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <footer>
        <a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'View %s', 'narga' ), the_title_attribute( 'echo=0' ) ) ); ?>" class="video-post-title" rel="bookmark"><?php the_title(); ?></a>
