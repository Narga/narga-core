...
if (!function_exists('narga_header')) :  
    function narga_header() {
        ...
        if ( !empty( get_header_image() ) && ( narga_options('custom_header_image_background') == 1 ) ) {
            echo '<div id="site-header" class="columns large-12 small-12 medium-12 site-header">';
            narga_custom_logo();
            echo '</div>';
        } elseif ( !empty( get_header_image() ) && ( narga_options('custom_header_image_background') == 0 ) ) {
            echo '<div id="site-header" class="large-12 small-12 medium-12">';
...
if ( ! function_exists( 'narga_custom_logo' ) ) :
    function narga_custom_logo() {
        echo '<div id="custom-header" class="custom-header">';
        # Custom logo
